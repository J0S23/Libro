...
pvalor
```
Finalmente, se evidencia que F<F_critico y también el p valor es 0.91>0.05, por lo tanto no se rechaza Ho, es decir, no existen diferencias significativas entre las medias de los tres tratamientos
